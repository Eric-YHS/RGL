...
export class World2D {
  ...
  private drawStickFigure(
    ...
    if (pedFrame) {
      this.drawPedestrianSpriteFrame(ctx, pedFrame, x, footY, h, pose);
    }
  }
  ...
  private getPedestrianSpriteFrame(
    ...
    const originalGlyph = this.getOriginalPedestrianGlyph();
    if (originalGlyph) {
      return { current: originalGlyph, next: null, mix01: 0 };
    }
